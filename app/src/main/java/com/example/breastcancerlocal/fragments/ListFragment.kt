...
class ListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        model = BreastCancerCRUDViewModel.getInstance(myContext)
    ...
    override fun onResume() {
        ...
        model.allBreastCancers.observe( this) { breastCancer ->
            breastCancer.let {
                (root as RecyclerView).adapter = ClassificationRecyclerViewAdapter(breastCancer, mListener!!)
            }
        }
    }
    ...
    interface OnListFragmentInteractionListener {
        fun onListFragmentInteraction(item: BreastCancerEntity)
    }
}
